...
<<<<<<< HEAD
              return JsonResponse({'status':'recommended','prediction': prediction})
=======
...
<<<<<<< HEAD
      Medical.objects.filter(pk= disease).update(medicine='Please Meet the Doctor')
      return JsonResponse({'status':'not recommended','message': 'Please Meet the Doctor'})
=======
